...
covid = pd.read_csv('/content/drive/MyDrive/GSTR410/owid-covid-data (1).csv')
...
cols_to_drop = ['new_cases', 'new_cases_smoothed','new_deaths',	'new_deaths_smoothed',
            ...
            'weekly_icu_admissions_per_million','total_vaccinations_per_hundred',	'people_vaccinated_per_hundred',
            'people_fully_vaccinated_per_hundred', 'new_people_vaccinated_smoothed',
            'population_density	median_age', 'total_cases_per_million',	'total_deaths_per_million	weekly_hosp_admissions',
            ...
            'total_boosters_per_hundred',	'new_vaccinations_smoothed_per_million', 'population_density',	'median_age',
...
covid = covid[covid.iso_code == 'IRN']
...
Country = Backdate[Backdate.iso_code == 'IRN']
Country.columns
...
sbn.heatmap(next[cols3].corr(), annot=True, cmap = 'viridis')
